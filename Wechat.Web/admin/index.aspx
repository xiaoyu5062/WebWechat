<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Wechat.Web.admin.index" %>
...
<head>
    ...
    <meta name="keywords" content="爆客系统">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    %>
                    <li>
                        <a class="J_menuItem" href="company.aspx"><i class="fa fa-bank"></i><span class="nav-label">公司管理</span></a>
                    </li>
                    <%}
                        if (user.level == -1 || user.level == 1 || user.level == 3)//企业主/代理
                        {
                    %>
                    <li>
                        <a class="J_menuItem" href="emp.aspx"><i class="fa fa-users"></i><span class="nav-label">员工管理</span></a>
                    </li>
                    <%} %>
                    <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                ...
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        <a class="navbar-minimalize minimalize-styl-2 btn btn-red " href="#"><i class="fa fa-bars"></i></a>
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li>
                            <a href="index.aspx?a=exit">
                                <i class="fa fa-sign-out"></i>退出
                               <%-- <asp:Button ID="btn_exit" class="fa fa-sign-out" runat="server" OnClick="btn_exit_Click" Text="退出"/>--%>
                            </a>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="footer">
                <div class="pull-right">
                    &copy; 2016-2017 <a href="http://www.9houkeji.com/" target="_blank">玖厚科技</a>
                </div>
            </div>
        </div>
